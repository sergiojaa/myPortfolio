...
export default function Skills() {
    ...
    return (
        <div className=' w-[280px] mx-auto lg:mx-0  '>
            <div className='flex  w-[280px] mx-auto flex-col  items-center lg:items-start justify-center'>
                <div>
                    <h2 className='text-white text-[30px] font-bold'>My <span className='ml-2'>Skills</span></h2>
                    <p className='w-[280px]  lg:w-[500px] text-[#ffffff99]'>Proficient in HTML, CSS, JavaScript, Next.js, React.js, Tailwind CSS, TypeScript, React, with a focus on building responsive and dynamic web applications.</p>
                </div>
