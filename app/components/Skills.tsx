    ...
    return (
        <div>
            <div>
                ...
                <p className='w-[550px] text-[#ffffff99]'>Proficient in HTML, CSS, JavaScript, Next.js, React.js, Tailwind CSS, TypeScript, React, with a focus on building responsive and dynamic web applications.</p>
                <div className='flex mt-5 flex-col gap-5'>
                    <div className='flex flex-wrap gap-4     w-[550px]   '>
